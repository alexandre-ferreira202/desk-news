...
export const Route = createFileRoute("/MULTIVIEW - playout")({
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {multiviewActive ? (
                <div className="grid grid-cols-2 gap-1 aspect-video bg-black rounded-lg overflow-hidden border border-cyan-600/20">
                  <div className="relative bg-black border border-cyan-600/30 flex items-center justify-center">
                    {youtubeVisible && youtubeUrl ? (
                      ...
                      <div className="flex items-center justify-center text-zinc-700 text-[10px] font-bold">CAM 1</div>
                    )}
                  </div>
                  <div className="relative bg-black border border-cyan-600/30 flex items-center justify-center">
                    <span className="text-zinc-700 text-[10px] font-bold">CAM 2</span>
                  </div>
                  <div className="relative bg-black border border-cyan-600/30 flex items-center justify-center">
                    <span className="text-zinc-700 text-[10px] font-bold">CAM 3</span>
                  </div>
                  <div className="relative bg-black border border-cyan-600/30 flex items-center justify-center">
                    <span className="text-zinc-700 text-[10px] font-bold">CAM 4</span>
                  </div>
                </div>
              ) : (
