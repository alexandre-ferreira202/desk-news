...
export const Route = createFileRoute("/ULTIMO _ playout")({
    ...
    <div className="fixed inset-0 text-white flex flex-col overflow-hidden font-sans" style={{ backgroundColor: '#121212', color: 'white' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-y-auto p-3 gap-3" style={{ backgroundColor: '#121212' }}>
          ...
          {/* ── LAUDA | Transport | GC | Vaga ── */}
          <div className="grid grid-cols-[auto_1fr_auto_1fr] gap-3 flex-1 min-h-0">
            ...
            {/* ─ Col 2: Controles ─ */}
            <div className="flex flex-col gap-3 w-[280px] overflow-y-auto border rounded-xl p-3" style={{ backgroundColor: '#1a1a1a', borderColor: '#2a2a2a' }}>
