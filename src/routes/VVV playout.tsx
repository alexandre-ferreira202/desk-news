...
export const Route = createFileRoute("/VVV playout")({
...
function PlayoutPage() {
  ...
  // ── VU Meter — analisa o áudio do player ativo via Web Audio API ──
  useEffect(() => {
    ...
    let analyser = vuAnalyserRef.current;
    if (!analyser) {
    ...
    try {
      ...
      // já conectado anteriormente — segue usando o analyser existente
    }
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                ...
                {/* VU METER */}
                <div className="absolute bottom-0 left-0 right-0 h-2 z-50" style={{ backgroundColor: '#0f0f0f', borderTop: '1px solid #2a2a2a' }}>
                  <div className="flex gap-[2px] h-full items-center px-1">
                    {Array.from({ length: 50 }).map((_, i) => {
                      const active = i < Math.round((vuLevel / 100) * 50);
