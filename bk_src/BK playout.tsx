  ...
  while (i < linhas.length) {
    ...
    if (linha.match(/^\[SONORA\]$/i)) {
      ...
      if (nome) {
        ...
        sonoras.push({ nome, funcao, texto, duracaoEstimada });
        itensLauda.push({
          tipo: "SONORA",
          nome: "SONORA",
          valor: `${nome} - ${funcao}`,
        ...
        console.log("✅ Sonora:", { nome, funcao, duracao: duracaoEstimada + "s" });
      }
    }
...
function PlayoutPage() {
  ...
  const progressRafRef = useRef<number | null>(null);
    ...
    materiaAtual.sonoras.forEach((sonora) => {
      ...
      map.set(key, { inicio: acumulado, duracao });
      timeline.push({
        nome: sonora.nome,
        funcao: sonora.funcao,
        timecodeInicio: acumulado,
        duracao
      });
      acumulado += duracao;
    });
