...
function PlayoutPage() {
  ...
  const handleMeFrameClear = (id: number, e: React.MouseEvent) => {
    e.stopPropagation();
    setMeFrames((prev) => {
      const next = [...prev];
      next[id] = null;
    ...
    <div className="fixed inset-0 text-white flex flex-col overflow-hidden font-sans" style={{ backgroundColor: '#121212', color: 'white' }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-y-auto p-3 gap-3" style={{ backgroundColor: '#121212' }}>
          ...
          {/* ── Transport Controls + LAUDA (4 colunas: transport + 3 sub-colunas da lauda) ── */}
          <div className="grid grid-cols-[auto_1fr] gap-3 flex-1">
            ...
            <div className="grid grid-cols-3 gap-3 overflow-hidden">
              ...
              {/* ── Sub-coluna 2: Vaga ── */}
              <div
                className="border rounded-xl p-3 flex flex-col overflow-hidden"
                style={{ backgroundColor: '#1a1a1a', borderColor: '#2a2a2a' }}
              >
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-2 text-zinc-800 border-2 border-dashed border-white/5 rounded-xl">
